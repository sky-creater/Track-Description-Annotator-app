...
<p align="center"><strong>一个用于多目标跟踪数据文本标注的跨平台桌面工具。</strong></p>
...
- 百度网盘：通过网盘分享的文件 [demo_dataset.zip](https://pan.baidu.com/s/19WOQ7pt966q4r1UTrtp4dg?pwd=tpwd)
- 提取码：`tpwd`

操作方法：

1. 点击 `Select Label Folder`，选择 label 文件夹：
   `yourpath/demo_dataset/label/LaSOT`
2. 点击 `Images Linked`，选择视频文件夹：
   `yourpath/demo_dataset/Image/LaSOT`

注意：

- 如果选错了文件夹，软件可能会卡住。
- 遇到这种情况，重新启动软件后再选择正确的文件夹即可。
